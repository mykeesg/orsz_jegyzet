...
\begin{document}
	...
	%TODO: variáns-függvény tétele
	%TODO: paraméter-tér bemutatása, pl. az A = ZxZ (x,y) és B=Z(x')-nél mi a paramétertér, ha annyit akar a program, hogy egy számhoz (x') hozzárendeli az y-ban a nála eggyel kisebb számot. (tökmindegy mit akar a paraméter jelenteni, azaz a (5,4), (5,2), (5,1), (5,25) állapotok mindegyikét egyként tudom az x'=5-tel jellemezni)
